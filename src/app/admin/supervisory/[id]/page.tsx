...
export default async function EditSupervisoryMemberPage({ params }: { params: { id: string } }) {
    const { id } = await params;
    const member = await getMember(id);

    if (!member) {
        redirect("/admin/supervisory");
    }
    ...
    return (
        <div>
            <div className="flex items-center gap-4 mb-8">
                ...
                <h1 className="text-3xl font-bold">Denetim Kurulu Üyesi Düzenle</h1>
            </div>
